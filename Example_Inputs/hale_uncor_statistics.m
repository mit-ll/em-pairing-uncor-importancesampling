...
%%
function [N_initial, N_transition] = hale_uncor_statistics()
% HALE_UNCOR_STATISTICS returns the sufficient statistics for the
% uncorrelated encounter model modified for a generic HALE (High Altitude,
% Long Endurance) aircraft
%
%   [N_initial N_transition] = hale_uncor_statistics()
%
...
% V - Airspeed (KTAS)
%           L =  500-1200  	1200-3000   3000-5000   5000+
N_initial{4} = [ 50         50          50          10;    % 50-100
                 50         50          50          60;    % 100-150
                  0          0           0          15;    % 150-200
                  0          0           0          15 ];  % 200-250
